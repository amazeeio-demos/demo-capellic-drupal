...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/amazeeio-demos/demo-capellic-drupal.git demo-capellic-drupal && cd $_
    ```
...
4. Visit the new site @ `http://demo-capellic-drupal.docker.amazee.io`
...
6. Visit the new site @ `http://demo-capellic-drupal.lndo.site`
